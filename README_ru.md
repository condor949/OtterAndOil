...
- **space-generator.py** – графический инструмент на PyQt5 для интерактивного
...
| Поле | Описание |
|------|----------|
| `clean_cache` | удалить старые данные в каталоге, указанном в `cache_dir`, перед запуском |
...
- `space-generator.py` — позволяет интерактивно создать файл пиков, описывающий
